...
You can install additional skill packs from the [Skill Registry](/features/skill-registry) — a community-driven collection of skills for email drafting, data analysis, git workflows, and more. Installed community skills are indexed into the Skill Graph and routed automatically, just like built-in tools.
