...
description: "A local-first AI agent for your desktop. Persistent memory, computer use, scheduled tasks, and intelligent skill routing — with any model you choose."
---

Ori is a desktop AI agent that runs entirely on your machine. It remembers your preferences, understands your projects, controls your screen, runs tasks on autopilot, and picks the right tools for every request.
