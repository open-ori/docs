...
Ori creates a **reminder** that fires in 20 minutes — you'll get a toast notification in the app and an OS-native alert, even if Ori is minimized. One-shot reminders auto-delete after firing.
...
Ori creates an **execution plan** — a multi-phase breakdown with tracked substeps. Each phase shows its status (pending, in progress, done) and you can ask Ori to work through them one by one.
...
<CardGroup cols={2}>
  ...
  <Card title="Reminders & scheduling" icon="clock" href="/features/scheduled-tasks">
    Set reminders, create recurring jobs, and let Ori manage your time.
  </Card>
  <Card title="Ambient intelligence" icon="radar" href="/features/ambient-intelligence">
    How Ori works in the background to surface what matters.
  </Card>
