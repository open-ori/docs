...
Ori handles time so you don't have to — from quick reminders to autonomous recurring jobs.
...
→ [Learn more about reminders & scheduled tasks](/features/scheduled-tasks)

### Ambient intelligence

Ori works in the background — monitoring your services and surfacing what matters without you asking.
...
- **Native notifications** — OS-level alerts even when Ori is minimized

→ [Learn more about ambient intelligence](/features/ambient-intelligence)
...
- **cancelIntent** — Cancel or remove reminders. Pass `"all"` to purge completed
