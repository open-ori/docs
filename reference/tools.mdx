...
Ori ships with 22+ built-in tools. The [Skill Graph](/features/skill-routing) automatically picks the right ones — you never need to specify which tool to use.
