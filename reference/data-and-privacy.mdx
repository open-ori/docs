...
Ori's source code is public at [github.com/open-ori/ori](https://github.com/open-ori/ori). You can inspect every line of code, verify the privacy claims, and build from source.
